...
**Frank Gao** · May 2026 · GATT v1.6 (paper-data synced, post-Google-I/O 2026) · CC BY 4.0
Live data: <https://gf691271.github.io/gatt/>
Source: <https://github.com/gf691271/gatt>

> **v1.6 paper rev note (May 20, 2026):** This revision synchronizes the paper tier with the v1.5.2 data tier following Sundar Pichai's Google I/O 2026 opening keynote of May 19-20 [42], which disclosed 3.2 quadrillion Gemini tokens/month across all surfaces (= 107T/day, up from v1.4's editorial 73T composite) plus 19B tokens/min API throughput. Headline numbers throughout the paper now reflect the v1.5.2 data tier: global volume 345T/day, Token GDP $115.6B/year, US/CN volume share 55%/45% (50/50 parity broken at I/O 2026), US Token GDP share 90%, US per-capita 561,200, US-India ratio 729×, Gini 0.698. The §5.5 four-factor decomposition arithmetic in this paper was developed against the v1.4 observable of G/L = 2.04 and is preserved as a structural argument pending refit (§5.1 preamble explains; §5.7 to be added at v1.6.1). The Bayesian sensitivity analysis in Appendix C similarly carries the v1.4 ratio. **The qualitative claims of this paper — China-US gap, US Token GDP dominance, per-capita inequality, 2× physics-ceiling tension — all strengthen under the v1.5.2 numbers**: 2.04× → 2.49× ratio, 597× → 729× US-India gap, 88% → 90% US Token GDP share, 0.674 → 0.698 Gini.

> **Note on PAPER-FULL.md vs. canonical chapter sources:** The body of this file beyond the header is, as of this commit, partially stale relative to the canonical chapter sources (`paper/abstract.md`, `paper/01-introduction.md`, ..., `paper/appendix-c-bayesian-sensitivity.md`) and to `paper/main.tex` (auto-built from chapter sources via `paper/build_tex.py`). The chapter sources and `main.tex` carry the v1.6 numbers throughout; PAPER-FULL.md will be regenerated from chapter sources via an auto-mirror script at v1.6.1. For citation purposes use either (a) `main.tex` (canonical), (b) the chapter `.md` files (canonical narrative), or (c) `data/tci-latest.json` (canonical numbers).
