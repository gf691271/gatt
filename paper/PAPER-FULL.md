...
**Frank Gao** · May 2026 · GATT v1.5 · CC BY 4.0
...
The 2026-05-14 GATT dataset is most consistent with **Trajectory A in the United States and an unstable position between Trajectory A and Trajectory C in China**. Volcengine's 49.5% China MaaS share (§2.2, IDC-validated) is already at the structural threshold beyond which state-anchor operator status becomes a discussible policy option in the Chinese institutional environment. The recurring CAICT framing of token throughput as a national-capability indicator (§2.2) is the kind of intellectual scaffolding that, in prior Chinese sectoral reorganizations (telecommunications 1998, petroleum 1998, electricity 2002), has preceded structural intervention by approximately three to five years. We flag this as a falsifiable hypothesis: if Volcengine's share climbs past 60% with concurrent CAICT and National Data Administration involvement, the Trajectory-C hypothesis is supported; if Volcengine's share plateaus or declines while Alibaba Bailian, Baidu Qianfan, or Tencent Hunyuan close the gap, Trajectory A or B is supported instead. The 36-month observation window beginning 2026-05-14 is sufficient to distinguish these outcomes.
