...
1. We **introduce GATT** — a daily empirical index of global AI inference token throughput across 21 vendors and 12 countries, with full revision history and confidence ratings.
...
4. We **propose "Token GDP"** — a vendor-volume × regional-blended-pricing metric — as a regional-comparable economic-value indicator for the Token Economy. This addresses a gap noted by Xing [6], who argues for a "Token Performance Index" as essential infrastructure for an emerging token futures market.
