...
In May 2026 — eighteen months ahead of that 2028 projection — the empirical Global AI Token Tracker (GATT) measures US per-capita token throughput at **561,200 tokens per resident per day** (post-Google-I/O 2026, May 19-20), or 2.49× the paper's 2028 ceiling.
